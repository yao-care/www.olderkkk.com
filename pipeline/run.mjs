...
【文風：去 AI 味】長短句交錯、每段換不同開法、每段一個具體事實、用台灣口語（容許口語瑕疵）。避免這些 AI 腔：破折號（——）下定義、『不是X而是Y』『不僅…更』『並非…而是』的公式對比句、『值得注意的是』『值得一提的是』『換句話說』、空泛收束（總的來說／綜上所述／總而言之／歸根結底／整體而言）、『真正的問題/關鍵是』『隨著…的發展』『在…的今天』、『至關重要／不可或缺／舉足輕重』、模糊引用（研究顯示／專家認為／普遍認為，要嘛附來源要嘛不寫）、模板化第一人稱開場。要對比就正面直述。內部連結只用 Markdown（禁 raw HTML）。
